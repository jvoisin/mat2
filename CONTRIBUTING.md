...
3. Update the version in the [pyproject.toml](https://github.com/jvoisin/mat2/blob/master/pyproject.toml) file
4. Update the version and date in the [man page](https://github.com/jvoisin/mat2/blob/master/doc/mat2.1)
...
9. Download the github archive of the release
...
12. Upload the signature on github [tag page](https://github.com/jvoisin/mat2/tags) and add the changelog there
13. Announce the release on the [mailing list](https://mailman.boum.org/listinfo/mat-dev)
14. Sign'n'upload the new version on pypi with `python3 -m build` then `twine upload -s dist/*`
